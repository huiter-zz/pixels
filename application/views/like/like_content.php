<ul class="breadcrumb">
  ...
  <li class="active"><span class="label">喜欢集(私密)</span></li>
</ul>
...
<?php foreach ($work_info as $key => $value) :?>
    <?php $time=mdate("%Y-%m",strtotime($value['likedate']));?>
        ...
        <?php endif;?>
            ...
            <li class="txt">
                ...
                <p class="data" url="<?php echo "/work/".$value['workid'];?>" style="display: none; "><?php echo mdate("%m月%d日",strtotime($value['likedate']));?></p>
            </li>
